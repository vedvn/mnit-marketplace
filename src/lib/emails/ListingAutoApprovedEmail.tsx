...
export default function ListingAutoApprovedEmail({
  ...
  return (
    <EmailLayout previewText="Your listing passed verification and is now live! ✅">
      <Section style={body}>
        <Text style={heading}> Auto-Verified & Live!</Text>
        <Text style={paragraph}>
          Hi {name}, great news — your listing for <strong>&quot;{productTitle}&quot;</strong> was
          instantly verified and is now <strong>live on the marketplace</strong>.
        </Text>
        <Text style={paragraph}>
          Our moderator confirmed that your live verification photo matched the item photos,
